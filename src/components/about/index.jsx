      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          <p className="font-light  text-xs sm:text-sm md:text-base   ">
            Enthusiastic Computer Science student with a passion for developing
            and a strong foundation in programming languages such as Python,
            JavaScript etc. Coupled with a collaborative mindset, poised to
            contribute effectively to innovative projects and teams.
          </p>
